        ...
        <Dialog open = {open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Configure the AI models and prompts for this node.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form 
                    ...
                    >
                        ...
                        <FormField
                            ...
                            render={({field}) => (
                                <FormItem>
                                    <FormLabel>Open AI Credential</FormLabel>
                                    <Select
                        ...
                        <FormField
                            ...
                            render = {({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea
                                            placeholder = "You are a helpful assisstant."
                                            className="min-h-[80px] font-mono text-sm"
                                            {...field}
                                        />
                                    </FormControl>
                                        <FormDescription>
                                            Sets the behaviour of the assisstant. Use {"{{variables}}"} 
